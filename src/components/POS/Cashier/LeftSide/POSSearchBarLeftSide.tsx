...
const POSSearchBarLeftSide: React.FC<Props> = ({ selectedOrder }) => {
  ...
  return (
    <div
      ref={searchRef}
      className="absolute w-[22vw] translate-y-[-1vw] z-50 flex flex-row"
    >
      <Input
        ref={inputRef}
      ...
      <button
        className="hover:text-[#967b30] px-[1vw] transition text-[1.2vw] flex items-center justify-center w-[2vw] h-[2vw] rounded-full hover:bg-gray-200 text-black"
        title="Trang chủ"
        onClick={() => navigate("/")}
      >
        <HomeOutlined />
